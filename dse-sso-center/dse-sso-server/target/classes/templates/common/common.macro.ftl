...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>DSE</b></span>
            <span class="logo-lg"><b>DSE SSO</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="${request.contextPath}/logout"   >
                            <span class="hidden-xs">注销【${dseUser.username}】</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018-${.now?string('yyyy')} &nbsp;
                <a href="https://github.com/yulang1992514" target="_blank" >xuxueli</a>
                &nbsp;
                <a href="https://github.com/yulang1992514" target="_blank" >github</a>
